package com.example.wheather.data.gps;
...
public class GPSTracker implements LocationListener {
    ...
    private static final long MIN_TIME_BW_UPDATES = DataConst.UpdateConfig.valueHourBy(AppSettings.periodHour()) * 1000L;
    ...
    public Location getLocation() {
        try {
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                ...
                Log.e("GPS","no provider is enabled");
            } else {
                ...
                if (isGPSEnabled) {
                    if (location == null) {
                        locationManager.requestLocationUpdates(
                                ...
                                MIN_TIME_BW_UPDATES,
                                MIN_DISTANCE_CHANGE_FOR_UPDATES, this);
                        LogUtils.E("GPS Enabled", "GPS Enabled");
                        if (locationManager != null) {
                            location = locationManager
    ...
    public void showSettingsAlert(){
        ...
        alertDialog.setPositiveButton(R.string.gps_settings, (dialog, which) -> {
